                                ...
                                <table cellspacing="0" class="shop_table cart">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-subtotal">TOP. ÜCRET</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-name">
                                                <a href="single-product.php">HALF LIFE</a> 
                                            </td>

                                            <td class="product-price">
                                                <span class="amount">15.00TL</span> 
                                            </td>
                                        ...
                                        <tr>
                                            <td class="actions" colspan="6">
                                                ...
                                                <input type="submit" value="SEPETİ GÜNCELLE" name="update_cart" class="button">
